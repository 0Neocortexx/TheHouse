...
import {
  ...
  shallowRef,
  watch
} from "./chunk-DSRE3ZWI.js";
import "./chunk-J43GMYXM.js";

// node_modules/vue-i18n/node_modules/@intlify/shared/dist/shared.esm-bundler.js
...
// node_modules/@intlify/core-base/node_modules/@intlify/shared/dist/shared.esm-bundler.js
...
// node_modules/@intlify/core-base/node_modules/@intlify/message-compiler/dist/message-compiler.esm-bundler.js
...
function createCompileError(code3, loc, options = {}) {
  ...
  const msg = true ? format2((messages || errorMessages)[code3] || "", ...args || []) : code3;
...
function getWarnMessage(code3, ...args) {
  return format2(warnMessages[code3], ...args);
}
...
function translate(context, ...args) {
  ...
  if (!resolvedMessage && !(isString2(format3) || isMessageFunction(format3))) {
    if (enableDefaultMsg) {
      format3 = defaultMsgOrKey;
      cacheBaseKey = format3;
    }
  }
  if (!resolvedMessage && (!(isString2(format3) || isMessageFunction(format3)) || !isString2(targetLocale))) {
...
function resolveMessageFormat(context, key, locale, fallbackLocale, fallbackWarn, missingWarn) {
  ...
  for (let i = 0; i < locales.length; i++) {
    ...
    if (isString2(format3) || isFunction2(format3))
      break;
...
function parseTranslateArgs(...args) {
  ...
  const options = {};
  if (!isString2(arg1) && !isNumber2(arg1) && !isMessageFunction(arg1)) {
